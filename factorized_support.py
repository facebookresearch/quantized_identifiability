...
This file is adapted from the repository of Disentanglement of Correlated Factors via Hausdorff Factorized Support written by Karsten Roth.
https://github.com/facebookresearch/disentangling-correlated-factors/blob/main/dent/losses/factorizedsupportvae.py
"""
...
class Loss(object):
    ...
    def __call__(self, data, z, **kwargs):
        ...
        loss = self.gamma * factorizedsupport_loss + self.delta * factorizedsupport_scale_reg
